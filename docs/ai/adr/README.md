...
| [012](./ADR-012-mobile-transfer-idempotency-lifecycle.md) | Mobile Transfer Idempotency Lifecycle | Accepted |
| [013](./013-maestro-mobile-e2e.md)                        | Maestro for Expo Mobile E2E           | Accepted |
